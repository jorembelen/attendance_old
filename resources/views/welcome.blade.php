      ...
      <div class="row h-100">
        <div class="col-lg-7 my-auto">
          <div class="header-content mx-auto">
            <h1 class="mb-5">Attendance App</h1>
            <a class="btn btn-outline btn-xl js-scroll-trigger" href="/home#!">Start Now</a>
          </div>
        </div>
            ...
            <div class="device-mockup iphone6_plus portrait gold">
              <div class="device">
                <div class="screen">
                  ...
                  <img src="/front/img/qrCode.png" class="img-fluid" alt="">
                </div>
                <div class="button">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          ...
          <div class="badges">
            <a class="badge-links" href="#"><img src="/front/img/appQR.png" alt="" height="200px"></a>
          </div>
          <div class="badges">
            <a class="badge-link" href="https://attendance.joreb.net/public/attendance.apk"><img src="/front/img/download.png" alt=""></a>
          </div>
        </div>
      </div>
    </div>
