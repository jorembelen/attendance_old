                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>All records for Attendance will be viewed here!</strong></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                                            ...
                                                            <table id="cbtn-selectors" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                @foreach ($timeIns as $timeIn) 
                                                                    <tr>
                                                                        ...
                                                                        <td> 
                                                                        <a href="#delete{{$timeIn->id}}" data-toggle="modal"><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
