...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Aug 2020 09:11:50 GMT -->
                    ...
                    <form class="md-float-material form-material" method="POST" action="{{ route('login') }}">
                     @csrf
                        <div class="text-center">
                            <!-- <img src="admin/files/assets/images/logo.png" alt="logo.png"> -->
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="password" name="password" id="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" class="form-control" required="">
                                    <span class="form-bar"></span>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Aug 2020 09:11:51 GMT -->
</html>
